...
//Guetters Setters ---------------------------------------------------------
	...
	public int getLayer(){
		if(this.parentElement1==null)	return 1;
			...
			return ModelConfiguration.getLevel(this.parentElement1.getRole());
		}
	}
 ...
 */
	...
	public int getCategory(){
		...
		if(elemnts1.size()==0){
			if(elemnts2.size()==0){
			}else cat = ModelConfiguration.getCategory(elemnts2.get(0).getRole());
		}else cat = ModelConfiguration.getCategory(elemnts1.get(0).getRole());
