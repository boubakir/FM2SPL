...
public class MergeManyModels extends JFrame  implements ActionListener {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MergeManyModels frame = new MergeManyModels();
	 ...
	 * Create the frame.
	 */
	public MergeManyModels() {
		
		ModelConfiguration.initialize();
		
		
		setTitle("Merge a set of models");
