...
public class NGramDistance implements StringDistance {
	  ...
	  public static void main(String[] args) {
		  ...
		  String s1 = "ExampleFileFilter";
		  String s2 = "ExamFileFilter";
		  
		  /*String s1 = "undoButton";
		  String s2 = "findButton";*/
			
		  
		  
		  NGramDistance ng = new NGramDistance(3);
		  float distance = ng.getDistance(s1.toLowerCase(), s2.toLowerCase()); 
